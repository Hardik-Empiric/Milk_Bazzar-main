...
class _BillState extends State<Bill> {
  ...
  calculateData() async {
    var totalLiter = await FirebaseFirestore.instance
        ...
        .doc("${yearMonth.year}")
        .collection("${yearMonth.month}").doc("total_liter").get();
  ...
  getData() async {
    int ddday = daysInMonth(int.parse(yearMonth.year),
        monthItemsInENGLISH.indexOf("${yearMonth.month}") + 1);
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.center,
                  child: GlobalText(
                    text: "${LocaleString().billOf.tr} ${yearMonth
                ...
                child: pw.Column(
                  children: [
                    ...
                    pw.Container(
                      ...
                      alignment: pw.Alignment.center,
                      child: pw.Text(
                        "${LocaleString().billOf.tr} ${yearMonth
                            .month} / ${yearMonth.year}",
                        style: pw.TextStyle(),
                      ),
                    ),
