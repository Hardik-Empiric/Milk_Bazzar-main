...
import '../../../Merchant/generate_bill_merchant/controller/generate_bill_merchant_controller.dart';
...
class _GenerateBillScreenState extends State<GenerateBillScreen> {
                            ...
                            children: [
                              ...
                              (!generateBillController.isLoading.value)
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    visible: !generateBillController.isLoading.value,
                                    child: Column(
                                     children: [
                                       commonField(
                                         color: Theme
  ...
  downloadPDF() async {
    ...
    final file = File('$tempPath/${showMonth}_${navigatorData.year}.pdf');
    print(file.path);
